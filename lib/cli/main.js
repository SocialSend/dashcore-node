...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .option('-d, --daemon', 'Make socialsendcore-node a daemon (running in the background)')
    .action(function(cmd){
      if (cmd.config) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `socialsendcore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ socialsendcore-node add wallet-service');
      console.log('    $ socialsendcore-node add insight-api-socialsend');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ socialsendcore-node remove wallet-service');
      console.log('    $ socialsendcore-node remove insight-api-socialsend');
      console.log();
    });
