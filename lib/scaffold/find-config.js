...
/**
 * Will return the path and socialsendcore-node configuration
...
function findConfig(cwd) {
  ...
  while (!fs.existsSync(path.resolve(directory, 'socialsendcore-node.json'))) {
  ...
  return {
    path: directory,
    config: require(path.resolve(directory, 'socialsendcore-node.json'))
  };
}
